...
const FeesAndPaymentInformation = (props: {
    ...
    const handleDeleteTableEntry = (index: number) => {
        updateForm({
            ...
            courseInfo: {
                ...formValue.courseInfo,
                transactions: formValue.courseInfo.transactions.filter((transaction, i) => index !== i),
            },
        })
    }
    ...
    const feesPaid = () => {
        let paid: number = 0
        formValue.courseInfo.transactions.map((transaction) => {
                                                    ...
                                                    <Tr key={index}>
                                                        <Td>
                                                            <Input
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    copied.courseInfo.transactions[index].receiptNo =
                                                                        e.target.value
                                                                    updateForm(copied)
                                                                }}
                                                            />
                                                        ...
                                                        <Td>
                                                            <Input
                                                                ...
                                                                onChange={(e) => {
                                                                    let copied = cloneDeep(formValue)
                                                                    copied.courseInfo.transactions[index].semester =
                                                                        e.target.value
                                                                    updateForm(copied)
                                                                }}
                                                            />
                                                        ...
                                                        <Td>
                                                            <Input
                                                                ...
                                                                onChange={(e) => {
                                                                    let copied = cloneDeep(formValue)
                                                                    copied.courseInfo.transactions[index].amount =
                                                                        e.target.value
                                                                    updateForm(copied)
                                                                }}
                                                            />
                                                        ...
                                                        <Td>
                                                            <Input
                                                                ...
                                                                onChange={(e) => {
                                                                    let copied = cloneDeep(formValue)
                                                                    copied.courseInfo.transactions[
                                                                        index
                                                        ...
                                                        <Td>
                                                            <div>
                                                                <DatePicker
                                                                    ...
                                                                    onChange={(date: any) => {
                                                                        let copied = cloneDeep(formValue)
                                                                        copied.courseInfo.transactions[index].date =
                                                                            date
                                                                        updateForm(copied)
                                                                    }}
                                                                />
